...
require '../src/Boleto/Boleto.php';

use EuMatheusGomes\Barcode\InterleavedTwoOfFive;
use EuMatheusGomes\Febraban\Boleto\Caixa;
...
$caixa = new Caixa($itf);
$caixa->setBanco(Caixa::CODIGO_BANCO)
    ->setMoeda('9')
    ->setCarteira(Caixa::CARTEIRA_COM_REGISTRO)
    ->setAgencia('9999')
    ->setModalidade(Caixa::MODALIDADE_EMISSAO_CEDENTE)
    ->setNumeroParcela('1')
    ->setVencimento(date('Y-m-d', strtotime('+9 days')))
    ->setValor('999.99')
    ->setCodigoCedente('999999')
    ...
    ->setNossoNumero('000000099999999')
    ->setDemonstrativo([
