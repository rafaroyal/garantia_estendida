...
<div class="modal-body" style='font-family: "Arial",sans-serif;text-transform: uppercase;'>
    <div class="row">
        <div class="col-md-6 col-md-offset-3" style="text-align: center;line-height: 1.15em;font-size: 11px;font-family: monospace;">
        ...
        <input type="hidden" name="id_parceiro" id="id_parceiro" value="<?php echo $id_parceiro_s; ?>"/>
            <div style="font-weight: bold;">TRAIL ASSISTÊNCIA TOTAL</div>
            <div >COMPROVANTE DE PAGAMENTO</div>
            <div >NÃO É DOCUMENTO FISCAL</div>

             <div class="row">
                <div class="col-md-6">
                    <label class="control-label col-md-12 label_comprovante_lc" style="float: left;">Data impressão:</label>      
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label class="control-label col-md-12 label_comprovante_rc" style="float: right;"><?php echo converte_data($data_pagamento); ?> às <?php echo $hora_pagamento;?></label>
                </div>
                <!--/span-->
            </div>
            <div class="row">
            ...
            <div class="row" style="border-bottom: 1px dashed #000000;">
                <div class="col-md-6">
                        <label class="control-label col-md-12 label_comprovante_lc" style="float: left;">USUÁRIO:</label>
                </div>
                <div class="col-md-6">
             ...
             <div class="row" style="border-bottom: 1px dashed #000000;">
             <div class="col-md-12">
                        <label class="control-label col-md-12 label_comprovante_lc" style="float: left;">Mantenha suas parcelas em dia e aproveite todos os benefícios da sua Assistência Familiar.</label>
                </div>
             </div>
        </div>
    </div>
