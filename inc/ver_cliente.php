                                ...
                                if (mysql_num_rows($query)>0)
                                {
                                    ...
                                    if($pago == 'N'){
                                        ...
                                        <?php
                                            ...
                                            if($tipo_boleto == 'LOJA'){
                                                $nome_arquivo_boleto = 'ver_boletos_cliente_'.$cobr_banco.'.php';
                                                if(!empty($cobr_url_boleto)){
                                                    $nome_arquivo_boleto = $cobr_url_boleto;
                                                }
                                                $link_boletos = 'boletos/'.$cobr_tipo_cobranca.'/'.$cobr_banco.'/'.$nome_arquivo_boleto;
                                                //$link_boletos = 'boletos/'.$cobr_tipo_cobranca.'/'.$cobr_banco.'/ver_boletos_cliente_loja.php';
                                                //$link_boletos = 'ver_boletos_cliente_loja.php';
                                                    ...
                                                    $link_boletos = 'boletos/'.$cobr_tipo_cobranca.'/'.$cobr_banco.'/'.$nome_arquivo_boleto;
                                                    //$link_boletos = 'boletos/'.$cobr_tipo_cobranca.'/'.$cobr_banco.'/ver_boletos_cliente.php';
                                    ...
                                    <?php
                                       ...
                                       <div class="btn-group">
                                           ...
                                           <ul class="dropdown-menu hold-on-click">
                                                ...
                                                <li>
                                                    <label style="padding: 8px 16px;"><a href="http://trailservicos.com.br/<?php echo $pasta; ?>/inc/ver_comprovante_cliente_2.php?id_boleto=<?php echo $id_boleto;?>" target="_blank" class="btn btn-sm purple "><i class="fa fa-barcode"></i> Comprovante</a></label> 
                                                </li>
                                                <li class="divider"> </li>
                                                <li>
                                                   <label style="padding: 8px 16px;font-size: 10px;"><?php echo $obs;?></label> 
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        ?>
                                                                ...
                                                                $verifica   = "SELECT data_alteracao FROM historicos_atividades 
                                                                            WHERE id_referencia = $id_cliente AND descricao LIKE '%Envio de SMS/COBRANÇA:%'
                                                                            ORDER BY id_historico DESC
                                                                            LIMIT 0,1";
...
?>
    <div class="modal-footer">
        ...
        if($status_cliente =='Ativo')
        {
            ...
            if(in_array("69", $verifica_lista_permissoes_array_inc)){
                ?>
        ...
        <a href="http://www.trailservicos.com.br/<?php echo $pasta;?>/condicoes_gerais/contrato_assistencia_geral.pdf" class="btn green"target="_blank">CERTIFICADO</a>
    ...
    WHERE id_ordem_pedido = $id_ordem_pedido";
                    ...
                    <a href="editar.php?item=cliente&tipo=produto&id_base=<?php echo $id_base_produto; ?>&slug=europ&id_produto=<?php echo $id_produto_get; ?>&id=<?php echo $id_cliente; ?>&id_grupo_produto=<?php echo $id_produto; ?>&plano_adicional=<?php echo $plano_adicional; ?>&msg_status=finalizar_venda&alterar_pagamento=true<?php echo $ativar_plano_cancelado;?>" class="btn btn-link"><i class="fa fa-random"></i> Alterar pagamento</a> 
                    <?php
                    if(in_array("67", $verifica_lista_permissoes_array_inc)){
                        ?>
