...
function verificarIDADE_add(d, id_dep){ 
    ...
    //variaveis do dia/mes/ano de hj	
    	...
    	if(idade > idade_maior_limite_titular)
        {
    ...
    <div class="portlet-body form">
        <input type="hidden" name="se_dependente[]" value="sim"/>
            ...
            <div class="row">
                ...
                <h5>** Data de Nascimento do cliente é OBRIGATÓRIO.</h5>
                </div>
            </div>
                <div class="row">
                <div class="col-md-3 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <select class="form-control parentesco" id="parentesco" name="parentesco[]">
                            <option value="" ></option>
                  ...
                  <div class="col-md-9 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="nome[]" class="form-control nome" id="nome" value="" style="text-transform: uppercase;" maxlength="40"/>
                ...
                <div class="col-md-3 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="cpf[]" class="form-control cpf" id="cpf" value="" onkeyup="return verificarCPF_dep(this.value, <?php echo $contar_dependente; ?>)"/>
                  ...
                  <div class="col-md-3 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="data_nasc[]" class="form-control data_nasc" id="data_nasc" value="" 
                        <?php
                ...
                <div class="row">
                  <div class="col-md-3 ">
                    ...
                    <div class="col-md-3 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="celular[]" class="form-control celular" id="celular" value=""/>
                 ...
                 <div class="row">
                  <div class="col-md-3 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="cep[]" class="form-control cep" id="cep" value="" style="text-transform: uppercase;" data="<?php echo $contar_dependente; ?>"/>
                    ...
                    <div class="col-md-2 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="numero[]" class="form-control numero" id="numero" value="" maxlength="4"/>
                 ...
                 <div class="row">
                  <div class="col-md-3 ">
                    ...
                    <div class="col-md-2 ">
                     <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" name="estado[]" class="form-control estado" style="text-transform: uppercase;" id="estado" value=""/>
                ...
                <input type="hidden" name="adicional_principal_contar_dependente_atual_<?php echo $contar_dependente;?>" id="adicional_principal_contar_dependente_atual_<?php echo $contar_dependente;?>" value="0"/>
                <input type="hidden" name="adicional_principal_contar_dependente[]" id="adicional_principal_contar_dependente_<?php echo $contar_dependente;?>" value="0"/>
                <input type="hidden" name="adicional_verifica_add_dependente[]" id="adicional_verifica_add_dependente_<?php echo $contar_dependente;?>" value="N"/>
                ...
                <div class="row"><div class="col-md-6">
                     <div class="form-actions noborder">
                        ...
                        ?>
                       <a href="javascript:" class="btn green" id="adicional_principal_bt_add_dependente_<?php echo $contar_dependente;?>" <?php echo $exibe_bt_add; ?>>Adicionar Dependente do adicional <i class="fa fa-plus"></i></a> <span id="div_aguarde_sel_plano_add_depe_add" style="display: none;"><img src="assets/global/img/loading-spinner-grey.gif"/> Aguarde, carregando dados...</span>
                     </div>
                     &nbsp;
                    </div></div>
                </div>
