                ...
                <div class="container">
                    ...
                    <div class="hor-menu  ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-dropdown mega-menu-dropdown active mega-menu-full">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <form class="form-horizontal">
                                                <div class="form-group form-group-lg">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select id="select2-button-addons-single-input-group-sm" class="form-control js-data-procedimento-ajax">
