    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "inc/table_ajax_est.php?item=" + item + "&id=" + id + '&tipo=' + tipo + '&id_grupo_parceiro=' + id_grupo_parceiro + '&id_serv_get=' + id_serv_get + '&tipo_filtro=' + tipo_filtro + '&id_usuario_pagamento=' + id_usuario_pagamento, // ajax source
