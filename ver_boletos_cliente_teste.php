...
$id_usuario_s    = $_SESSION['usr_id'];
$id_parceiro_s   = $_SESSION['usr_parceiro'];
...
<table width="740" border="0" cellspacing="0" cellpadding="5" id="tabela_boleto" <?php echo $html_quebra_pagina;?>>
  <tr>
    ...
    <img src="assets/pages/img/logo_boleto.jpg" style="width: 100px;margin-left: 5px;" />
    </td>
  ...
  <tr>
    ...
    >> STAR CLIN ASSISTÊNCIA TOTAL << <br />
  ...
  <tr>
    ...
    <td>(+) Juros <?php echo $porcento_valor_diario_vencimento_boleto;?>% ao mês<br />
    <span class="normal_bold">&nbsp;</span>
    </td>
  </tr>
  <tr>
